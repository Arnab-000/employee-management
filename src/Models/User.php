...
namespace Reddot\Employee\Management\Models;
...
class User extends Authenticatable implements HasMedia
{
    ...
    public function scopeActive($query)
    {
     ...
     /**
     * Scope to return user based on email.
     *
     * @var Builder
     */
    ...
    {
        $setting = \ProcessMaker\Models\Setting::byKey('users.timezone');
        if ($setting === null) {
    ...
    {
        $notifications = \ProcessMaker\Models\Notification::query()
    ...
    {
        return $this->morphMany(\ProcessMaker\Models\ProcessTaskAssignment::class, 'assigned', 'assignment_type', 'assignment_id');
    }
     ...
     * @return bool
     */
    public function canSelfServe(\ProcessMaker\Models\ProcessRequestToken $task)
    {
    ...
    public function availableSelfServiceTaskIds()
    {
        ...
        $taskQuery = \ProcessMaker\Models\ProcessRequestToken::select(['id'])
        ->where([
    ...
    {
        return $this->hasMany(\ProcessMaker\Models\ProcessRequestToken::class, 'user_id')
                    ->where('status', 'ACTIVE')
                    ->where('element_type', 'task');
    }
    
    // Relatonshio with the Hr4uEmployee Model
    public function employee()
    {
        return $this->hasOne(Hr4uEmployee::class, 'email', 'email');
    }
    ...
    // Accessor for Division Name
    public function getDivisionAttribute()
    {
        return $this->employee->division ?? null;
    }
    ...
    {
        return $this->employee->unit ?? null;
    }

    //For Unit Id
    public function getUnitIdAttribute()
    {
        return $this->employee->unit_id ?? null;
    }

    //For Position Id
    public function getPositionIdAttribute()
    {
        return $this->employee->position_id ?? null;
    }

    // Accessor for Designation
    public function getDesignationAttribute()
    {
        return $this->employee->designation ?? null;
    }

    // Accessor for Mobile Number
    public function getMobileAttribute()
    {
        return $this->employee->mobile ?? null;
    }

    // Accessor for Hierarchy Manager ID
    public function getHierarchyManagerIdAttribute()
    {
        return $this->employee->hierarchy_manager_id ?? null;
    }

    // Accessor for Hierarchy Manager Name
    public function getHierarchyManagerNameAttribute()
    {
        return $this->employee->hierarchy_manager_name ?? null;
    }

    // Accessor for Hierarchy Manager Email
    public function getHierarchyManagerEmailAttribute()
    {
        return $this->employee->hierarchy_manager_email ?? null;
    }

    // Accessor for Hierarchy Manager Position ID
    public function getHierarchyManagerPositionIdAttribute()
    {
        return $this->employee->hierarchy_manager_position_id ?? null;
    }

    // Accessor for Position Text
    public function getPositionTextAttribute()
    {
        return $this->employee->position_text ?? null;
    }

    // Accessor for Division ID
    public function getDivisionIdAttribute()
    {
        return $this->employee->division_id ?? null;
    }

    // Accessor for Department ID
    public function getDepartmentIdAttribute()
    {
        return $this->employee->department_id ?? null;
    }

     //Accessor for Cost Center ID
    public function getCostCenterIdAttribute()
    {
        return $this->employee->cost_center_id ?? null;
    }

    //Accessor for Cost Center Description
    public function getCostCenterDescriptionAttribute()
    {
        return $this->employee->cost_center_description ?? null;
    }

    // Accessor for Employee Band
    public function getEmployeeBandAttribute()
    {
        return $this->employee->employee_band ?? null;
    }

    //Get Company Name
    public function company(string $type = 'short'): string
    {
        return $this->employee ? $this->employee->company($type) : null;
    }

    //Accessor for Vendor Code
    public function getVendorCodeAttribute()
    {
        return $this->employee->vendorCode() ?? null;
    }

    //Accessor for Second Level Supervisor ID
    public function getSecondLevelSupervisorIdAttribute()
    {
        return $this->employee->second_level_supervisor_id ?? null;
    }

    //Accessor for Third Level Supervisor ID
    public function getThirdLevelSupervisorIdAttribute()
    {
        return $this->employee->third_level_supervisor_id ?? null;
    }

    //Accessor for Gender
    public function getGenderAttribute()
    {
        return $this->employee->gender ?? null;
    }

    //Accessor for Office Location
    public function getOfficeLocationAttribute()
    {
        return $this->employee->office_location ?? null;
    }

    //Accessor for Joining Date
    ...
    {
        return $this->belongsTo(Process::class, 'id')->withDefault();
    }
}